...
const App = () => {
  ...
  const handleSignup = () => {
    ...
    if (gender === "") {
      setGenderError(
        "Gender is not indicated. Please click on either of the 3 buttons"
      );
    }
    if (firstName === "") {
        ...
        <Switch>
          ...
          <Route path="/Forget">
            <Forget
              ...
              emailResetError={emailResetError}
              setEmailResetError={setEmailResetError}
            />
          </Route>
          ...
          <Route path="/Trade">
            {user ? (
              <Trade handleLogout={handleLogout} />
            ) : (
              <Login
                email={email}
                setEmail={setEmail}
